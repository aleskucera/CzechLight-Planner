...
// function drawClusteredNodesOld(map, deviceCoordinates, layer = 0) {
//     const sourceId = 'node-circles-source-' + layer;
//     const layerIdClusters = 'clusters-' + layer;
//     const layerIdClusterCount = 'cluster-count-' + layer;
//     const layerIdUnclusteredPoint = 'unclustered-point-' + layer;
//
//     // Remove the existing layers if they exist
//     if (map.getLayer(layerIdClusters)) {
//         map.removeLayer(layerIdClusters);
...
//         data: {
//             type: 'FeatureCollection',
//             features: deviceCoordinates.map((coords) => ({
//                 type: 'Feature',
//                 geometry: {
//                     type: 'Point',
//                     coordinates: coords,
...
//             geometry: {
//                 type: 'LineString',
//                 coordinates: [nodeCoordinates[i], nodeCoordinates[i + 1]],
//             },
//         });
//     }
//
